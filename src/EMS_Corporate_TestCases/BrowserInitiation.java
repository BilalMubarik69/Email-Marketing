...
if(browser.equalsIgnoreCase("firefox")) {
			...
			setHtmlReporter(new ExtentHtmlReporter(System.getProperty("user.dir")+"/FireFoxReports/EmailMarketing_Corporate_Report"+".html"));
			...
			getHtmlReporter().getEndTime();	
				...
				setHtmlReporter(new ExtentHtmlReporter(System.getProperty("user.dir")+"/ChromeReports/EmailMarketing_Corporate_Report"+".html"));
				setExtent(new ExtentReports());
				getExtent().attachReporter(getHtmlReporter());
				getExtent().setSystemInfo("HostName", "Bilal Mubarik");
				getExtent().setSystemInfo("Environment", EMS_TestData.CRMandOrders_URL);
		  ...
		  else if(browser.equalsIgnoreCase("edge"))
	   		{
	   			...
	   			setHtmlReporter(new ExtentHtmlReporter(System.getProperty("user.dir")+"/EdgeReports/EmailMarketing_Corporate_Report"+".html"));
				setExtent(new ExtentReports());
				getExtent().attachReporter(getHtmlReporter());
				getExtent().setSystemInfo("HostName", "Bilal Mubarik");
				getExtent().setSystemInfo("Environment", EMS_TestData.CRMandOrders_URL);
