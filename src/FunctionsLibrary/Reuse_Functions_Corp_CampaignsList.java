...
public class Reuse_Functions_Corp_CampaignsList extends EMS_Corporate_CampaignList_Execution {
	...
	public static void Hover(WebElement element,WebDriver driver) {
	 ...
	 public static void PageLoad(WebDriver driver,WebDriverWait wait,Predicate<WebDriver> pageLoaded) throws InterruptedException {
