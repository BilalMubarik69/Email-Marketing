...
public class CreateListWithReceipientAndContacts extends EMS_Execution {
	...
	public static void Indivisual_ContactsUnderList_Add_FromCampaign() throws InterruptedException{
		try{
    	 ...
    	 ListWithContacts.AddContactsToList_Field.sendKeys("m");
    	 
    	 Thread.sleep(4000);
    	 
         ListWithContacts.AddContactsToList_Field.sendKeys("mubarik@asicentral.com");
    	 ...
    	 if(ListWithContacts.ListContactsVerification.getText().contains("mmubarik@asicentral.com") & ListWithContacts.ListContactsVerification.isDisplayed())
    	 {
