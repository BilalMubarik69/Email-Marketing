...
public class ListManagementPage_Features extends EMS_Execution {
    ...
    public static void AddNewIndivisualContact_ListManagementPage() throws InterruptedException{
    	try{
    	 ...
    	 ListManagementFeatures.GivenFirstNameField_IndivisualContact.sendKeys("Bilal");
    	 
    	 ListManagementFeatures.GivenLastNameField_IndivisualContact.sendKeys("Mubarik");
