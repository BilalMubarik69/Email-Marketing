...
public class CreateListAndContactsFromListPage extends EMS_Execution {
	...
	public static void Indivisual_ContactsUnderList_Add_FromListPage() throws InterruptedException{
		try{
    	 ...
    	 CreateListAndContacts.AddContactsToList_Field.sendKeys("m");
    	 
    	 Thread.sleep(4000);
    	 
         CreateListAndContacts.AddContactsToList_Field.sendKeys("mubarik@asicentral.com");
    	 ...
    	 if(CreateListAndContacts.ListContactsVerification.getText().contains("mmubarik@asicentral.com") & CreateListAndContacts.ListContactsVerification.isDisplayed())
    	 {
