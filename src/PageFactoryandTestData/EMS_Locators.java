...
public class EMS_Locators {
	...
	//======================================================ESP Web Login Locators======================================================//
		...
		@FindBy(xpath="//input[contains(@id,'asilogin_AsiNumber')]")
		public WebElement ASINo;
		
		@FindBy(id="asilogin_UserName")
		public WebElement UserName;
		
		@FindBy(id="asilogin_Password")
  ...
  //===========================================================Landing Main Page Locators=======================================//
		...
		@FindBy(xpath="//*[contains(text(),'Email Marketing')]")
  ...
  //=========================================================Campaigns Locators==================================================//
       ...
       public String TemplatesDisplay_Wait;
        ...
        @FindBy(css="body > section > section > ui-view > div > div.row.padding-top-10 > div:nth-child(1) > h2")
       ...
       /* @FindBy(xpath="//div[contains(@class,'tile-row clearfix ng-scope')]/div/div[1]/div/div[3]//a[contains(text(),'Preview')]")
        ...
        @FindBy(xpath="//button[contains(@class,'btn btn-sm btn-primary ems-btn-narrow ems-width-three-tenth')]")
       ...
       @FindBy(xpath="//a[contains(@ng-click,'backToCampaign')]")
     ...
     @FindBy(xpath="//span[contains(text(),'asi/109480 AIA Corporation Company, asi/444012 AIA/My Corporate Expressions')]")
    ...
    //asi/109480 AIA Corporation Company, asi/444012 AIA/My Corporate Expressions
     ...
     @FindBy(xpath="//span[contains(text(),'asi/320879 AIA Corporate Production Testing Company, asi/320880 AIA OWNER A Production Testing Company')]")
