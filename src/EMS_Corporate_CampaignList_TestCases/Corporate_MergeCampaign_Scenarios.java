...
public class Corporate_MergeCampaign_Scenarios extends EMS_Corporate_CampaignList_Execution {
 ...
 Reuse_Functions_Corp_CampaignsList.waitForPageLoad(getDriver(), wait, pageLoaded);
   ...
   //Press the Next Button to move to send Campaign Step
     ...
     if(CorporateMergeCampaigns.SendStep_SendMailDrop_WithMultipleTenentSelection_VerificationStage.isDisplayed())
     {
	...
	public static void MergeCampaignPreview_ParentAddressVerification() throws InterruptedException, IOException{
	 ...
	 {	 
	  ...
	  TenentSelection=CorporateMergeCampaigns.TenentSelection_Preview_MergeCampaign;
		...
		dropdownValue.selectByVisibleText("asi/109480 AIA Corporation 3.");
	 }
	 else if(getDriver().getCurrentUrl().contains("uat"))
	 {
		 TenentSelection=CorporateMergeCampaigns.TenentSelection_Preview_MergeCampaign;
		 dropdownValue= new Select(TenentSelection);
		 dropdownValue.selectByVisibleText("asi/109480 AIA Corporation Company");
	 }
	 
	 else{
		 TenentSelection=CorporateMergeCampaigns.TenentSelection_Preview_MergeCampaign;
			dropdownValue= new Select(TenentSelection);
			dropdownValue.selectByVisibleText("asi/320879 AIA Corporate Production Testing Company");
	 }
	...
	public static void MergeCampaignPreview_ChildAddressVerification() throws InterruptedException, IOException{
		try{
		 if(getDriver().getCurrentUrl().contains("stage")){
			TenentSelection=CorporateMergeCampaigns.TenentSelection_Preview_MergeCampaign;
			dropdownValue= new Select(TenentSelection);
			dropdownValue.selectByVisibleText("asi/444012 MACPAK Pakistan");
		 }
